let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `EMMY_HENZ-V3 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VangYOt96H4JhFarL10C.\n\n ${Config.botname} *©EMMY - HENZ*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*EMMY_HENZ-V3 CURRENTLY ACTIVE!*";
