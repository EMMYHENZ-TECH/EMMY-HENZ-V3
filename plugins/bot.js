...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By EMMY_HENZ-V3, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
  ...
  if (bio && bio.autobio && typeof bio.autobio === "string" && bio.autobio != "false") {
    if (!isStartAutoBio) {
      ...
      abioJob = cron.schedule("*/1.5 * * * *", async () => {
        try {
          var _0x4b4b3b = "`";
          let _0x34c0a6 = bio.autobio == "true" || bio.autobio == "on" ? "Auto Bio By EMMY_HENZ-V3, ⏰Time: @time 🚀@bot" : bio.autobio;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent 'EMMY_HENZ-V3' yet!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared 'EMMY_HENZ-V3'!*");
    }
    let _0x1b2187 = "*[EMMY_HENZ-V3 Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent 'EMMY_HENZ-V3' yet!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared 'EMMY_HENZ-V3'!*");
    }
  } catch (_0x5bad57) {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent 'EMMY_HENZ-V3' yet!_*\n*_Can't disable cmds for shared users, If the bot is not shared!_*");
    }
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["Share [EMMY_HENZ-V3] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
