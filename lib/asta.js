...
setMention.get = async _0x2cdc1a => {
  try {
    ...
    if (_0x584f1d.get) {
      ...
      return await _0x2cdc1a.reply("*You did'nt set mention message yet!*\n*please Check: https://github.com/EMMYHENZ-TECH/EMMY-HENZ-V3/wiki/mention*");
    }
  } catch (_0x4535a8) {
...
setMention.cmd = async (_0x501ec5, _0x2a1c43 = "") => {
  try {
    ...
    if (_0x2a1c43 === "get" || _0x2a1c43 === "info" || !_0x2a1c43 && _0x22516b.status && _0x22516b.get) {
      ...
      _0x501ec5.reply("_Read wiki to set mention message https://github.com/EMMYHENZ-TECH/EMMY-HENZ-V3/wiki/mention_", {}, "smd");
